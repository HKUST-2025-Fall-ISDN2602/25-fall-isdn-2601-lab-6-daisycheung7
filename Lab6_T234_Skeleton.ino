...
double ki = 0.000000000000001;  // integral gain
double kd = 1;
Okay 
//PID Varibles 
...
int Task = 3 ; //Change this according to the task that you are doing 
...
double getPosition() {
  ...
  // Note: Change 1000.0 to your encoder's actual counts per revolution
